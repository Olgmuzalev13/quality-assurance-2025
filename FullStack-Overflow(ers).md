...
8. Отображается быть drop-down меню с видом работы "Постоянная", "Временная", "Разовая".  
![alt text](img/vacancy_page/vidi_rabot.png)

9. Отображается быть drop-down меню с видом работы "Художник", "Дизайнер", "Музыкант", "Фотограф", "Видеограф", "Артист/Актёр", "Писатель".  
