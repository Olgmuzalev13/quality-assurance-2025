...
4. При выполнении поиска (нажатии enter в поле поиска) и нахождении совпадений отображается список совпадений, отсортированный от наибольшего совпадения к наименьшему (совпадение по нескольким критериям > совпадения по одному)
