...
10. Имя, фамилия и город валидируются согласно [правилам валидации](#правила-валидации):
   * валидным именем или фамилией считается слово (набор букв) на русском или английском языке
   * валидным городом считается любая строка на русском или английском языках с пробелами и знаками "-"
...
![img](img\profile\city_edit_invalid.png)

11. Возраст, согласно введённой дате рождения [валидируется](#правила-валидации), на то, что пользователь старше 18 лет.
...
12. Дата рождения не принимает даты из будущего
...
14. После изменения данных профиля работодателя в форме, изменятся и данные на самой странице профиля

>  $\text{\color{red}Баг}$  
>  Изменённые данные без ручной перезагрузки страницы не обновляются

15. Аватар работодателя добавляется
