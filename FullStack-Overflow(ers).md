...
9. Input "Сайт компании" позволяет ввести любой текст.
...
1. В профиле работодателя в разделе "Вакансии" отоображается весь список вакансий пользователя.
...
2. В собственном профиле работодателя, нажатие на кнопку "Добавить" открывает форму создания вакакнсии (описано в разделе [страница вакансии](#страница-вакансии))

![img](img/vacancy_and_cv_list/add_button.png)

3. В собственном профиле работодателя, нажатие на кнопку "Изменить" открывает форму редактирования вакакнсии (описано в разделе [страница вакансии](#страница-вакансии))

![img](img/vacancy_and_cv_list/edit_button.png)

4. Нажатие на название вакансии направляет на [страницу](#страница-вакансии) вакансии, соответсвующую названию

![img](img/vacancy_and_cv_list/vacancy_titile.png)

5. В случае, если у работодателя нет вакансии, то отображается текст "Пока ничего нет" и кнопка "Добавить".

![img](img/vacancy_and_cv_list/vacancies_list_empty.png)

#### Список резюме

1. В профиле соискателя в разделе "Резюме" отоображается весь список резюме пользователя.

![img](img/vacancy_and_cv_list/cv_list.png)

2. В собственном профиле соискателя дополнительно имеет кнопки:
    * Добавить
    * Изменить

![img](img/vacancy_and_cv_list/cv_list_own.png)

2. В собственном профиле соискателя, нажатие на кнопку "Добавить" открывает форму создания вакакнсии (описано в разделе [страница резюме](#страница-резюме))

![img](img/vacancy_and_cv_list/add_button.png)

3. В собственном профиле работодателя, нажатие на кнопку "Изменить" открывает форму редактирования резюме (описано в разделе [страница резюме](#страница-резюме))

![img](img/vacancy_and_cv_list/edit_button.png)

4. Нажатие на название резюме направляет на [страницу](#страница-резюме) резюме, соответсвующее названию

![img](img/vacancy_and_cv_list/vacancy_titile.png)

5. В случае, если у соискателя нет резюме, то отображается текст "Пока ничего нет" и кнопка "Добавить".
