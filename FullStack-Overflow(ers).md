...
> ${\color{red}Баг}$ \
> Если попробовать попасть на страницу введя существующий url содержащий 2 или более "/" в адресную строку, а не через сайт, страница не загрузится. При попытке попасть на страницу создания новых сущностей [например](https://uart.site/cv/new) не поэтапно (из профиля) то сайт не загрузит даже 404.
