...
1. При вводе некорректного url на сайте отображается такое окно, с возможностью вернуться на главную страницу

![alt text](./img/404/404_correct.png)

> ${\color{red}Баг}$
> При попытке попасть на страницу создания новых instance [например](https://uart.site/cv/new) не поэтапно (из профиля) то сайт не загрузит даже 404.
