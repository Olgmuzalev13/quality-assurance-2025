...
9. Email "@" не является корректным.

10. Email "a@" является корректным.

11. Email "@a" не является корректным.

12. Email "' '@a" является корректным.
...
14. При вводе правильных данных входа и нажатии на кнопку "Войти", внизу по центру
