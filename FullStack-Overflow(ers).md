...
10. При вводе некорректной строки в поле "Должность", должно выводиться сообщение об ошибке.
...
11. Поле "Перевод должности на английский" удовлетворяет [правилам](#правила-валидации) валидации
