...
2. В собственном профиле работодателя, нажатие на кнопку "Добавить" открывает форму создания вакансии (описано в разделе [страница вакансии](#страница-вакансии))

![img](img/vacancy_and_cv_list/add_button.png)

3. В собственном профиле работодателя, нажатие на кнопку "Изменить" открывает форму редактирования вакансии (описано в разделе [страница вакансии](#страница-вакансии))
...
2. В собственном профиле соискателя, нажатие на кнопку "Добавить" открывает форму создания резюме (описано в разделе [страница резюме](#страница-резюме))
