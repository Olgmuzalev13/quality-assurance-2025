...
> ${\color{red}Баг}$ \
> 6. Поиск игнорирует служебные части речи, дабы искать только совпадения ключевых слов, что может привести к отсутствию результатов если в поиске использовать только служебные слова, даже те которые встречаются в вакансиях.  
>  ![alt text](./img/filters_and_search/ignoring_prepositions_search.png)

7. При одновременном поиске и фильтрации заголовок включает не только поисковый запрос пользователя но и выбранную им категорию, например "Вакансии по запросу «оформитель» в категории «Художник»"
...
5. Нажатие на название вакансии направляет на [страницу](#страница-вакансии) вакансии, соответсвующую названию
...
5. Нажатие на название резюме направляет на [страницу](#страница-резюме) резюме, соответсвующее названию
