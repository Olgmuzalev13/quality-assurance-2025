...
6. Служебные части речи при поиске игнорируются. Поиск по служебному слову должен иметь такой же результат, как и поиск по пустой строке.

> ${\color{red}Баг}$ \
> Для поискового запроса с одним служебным словом поиск осуществляется по этому слову. 
...
1. В профиле работодателя в разделе "Вакансии" отображается весь [список вакансий пользователя](https://uart.site/me?from=vacancyList).
...
3. В собственном профиле работодателя, нажатие на кнопку "Добавить" открывает [форму создания вакансии](https://uart.site/vacancy/new) (описано в разделе [страница вакансии](#страница-вакансии))

![img](img/vacancy_and_cv_list/add_button.png)

4. В собственном профиле работодателя, нажатие на кнопку "Изменить" открывает [форму редактирования вакансии](https://uart.site/vacancy/edit?id=8) (описано в разделе [страница вакансии](#страница-вакансии))
...
1. В профиле соискателя в разделе "Резюме" отображается весь [список резюме](https://uart.site/me?from=cvList) пользователя.
...
3. В собственном профиле соискателя, нажатие на кнопку "Добавить" открывает [форму создания резюме](https://uart.site/cv/new) (описано в разделе [страница резюме](#страница-резюме))

![img](img/vacancy_and_cv_list/add_button.png)

4. В собственном профиле работодателя, нажатие на кнопку "Изменить" открывает [форму редактирования резюме](https://uart.site/cv/edit?id=3) (описано в разделе [страница резюме](#страница-резюме))

![img](img/vacancy_and_cv_list/edit_button.png)

5. Нажатие на название резюме направляет на [страницу](https://uart.site/cv?id=3) этого резюме
...
3. Если зайти на страницу вакансии под аккаунтом соискателя то будет доступна кнопка "Откликнуться"
...
6. При нажатии "Изменить" открывается [форма редактирования резюме](https://uart.site/cv/edit?id=2) 
...
8. Нажатие на кнопку "Все резюме" перенаправляет на [список](https://uart.site/profile?id=1&userType=applicant&from=cvList) всех резюме соискателя.
